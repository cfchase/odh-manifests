...
ctrl_dir="openshift-notebook-controller"
ctrl_repository="github.com/samuelvl/kubeflow"
ctrl_branch="openshift-notebook-controller"
ctrl_image="quay.io/samuvl/openshift-notebook-controller"
ctrl_tag="v1.5.0-rc.0-24-g74dcb42e"
...
tmp_dir=$(mktemp -d)
ctrl_controller_dir=${tmp_dir}/components/openshift-notebook-controller
git clone \
...
yq -i '.commonLabels += {"component.opendatahub.io/name":"openshift-notebook-controller"}' ${ctrl_dir}/default/kustomization.yaml
